...
class Bootstrap
{
	...
	public static function formMultiPart($action = '', $htmlOptions = array())
	{
		return form_open_multipart($action, $htmlOptions);
	}
    ...
    public static function submit($label, $htmlOptions = array())
    {
        self::addCssClass('btn', $htmlOptions);
        self::replaceValue('class', 'color', self::BUTTON_COLOR_DEFAULT, $htmlOptions, 'btn-');
        self::changeValue('class', 'size', $htmlOptions, 'btn-');
        ...
        return self::tag('submit', $htmlOptions, $label, false);
    }
...
class TbForm extends Bootstrap
{
    ...
    public function submitButton($label, $htmlOptions = array())
    {
        ...
        return $this->formControlGroup('', $this->submit($label, $htmlOptions) . $help);
    }
