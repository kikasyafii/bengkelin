...
<html lang="en">
	...
	<title>
	.: <?php echo 'ADMIN PAGE --- '.$this->bengkelin->config['title']; ?> :.
	</title>
	<?php echo link_tag(base_url().'assets/css/yeti-bootstrap.min.css'); ?>
		...
		<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="container">
				<div class="navbar-header">
					<a class="navbar-brand" href="<?php echo base_url(); ?>"><?php echo $this->bengkelin->config['website_name']; ?> </a>
				</div>
				<div class="collapse navbar-collapse">
					<?php echo $this->bengkelin->menu(1); ?>
