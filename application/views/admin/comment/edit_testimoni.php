...
<?php $form = Tb::form(array('type' => Tb::FORM_TYPE_HORIZONTAL, 'action' => 'comments/save_edit_testimoni')); 
...
echo '<div class="form-group">
	<div class="col-md-5 center">'.form_submit('save', 'Simpan Perubahan', 'class="btn btn-primary btn-sm"').'</div>
</div>';
$form->end();
