				...
				<div class="col-md-3 col-sm-4 gallery-img">
					...
					<?php $namafile = ($row->name_file == '') ? base_url().'assets/images/galleries/bengkel.png' : base_url().'assets/images/galleries/bengkel/'.$row->name_file; ?>
						...
						<div class="tools tools-bottom">
							<a href="<?php echo site_url('gallery/delete_bengkel?gallery_id='.$row->gallery_id); ?>" title="DELETE" onclick="javascript:xconfirm=confirm('Apakah Anda yakin mau menghapus gambar ini?');if (xconfirm==true) { return true; } else { return false;}">
