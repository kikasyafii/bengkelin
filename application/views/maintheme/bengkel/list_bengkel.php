		...
		<div class="col-md-3 sidebar">
			<div class="block block-shadow white filter-cars">
				<div class="block-inner">
					...
					<!-- /.block-title -->
					<?php if ($jenis == 'Bengkel'): ?>
					<?php echo form_open('bengkel/list_bengkel'); ?>
					<?php else: ?>
					<?php echo form_open('bengkel/list_showroom'); ?>
					<?php endif; ?>
						<div class="form-section">
							<div class="form-group">
							<?php if ($jenis == 'Bengkel'): ?>
								<?php echo form_dropdown('jenis_id', array('' => 'Semua Jenis Bengkel', '1' => 'Bengkel Motor', '2' => 'Bengkel Mobil'), $jenis_id, 'class="form-control"'); ?>
							<?php else: ?>
								<?php echo form_dropdown('jenis_id', array('' => 'Semua Jenis Showroom', '3' => 'Showroom Motor', '4' => 'Showroom Mobil'), $jenis_id, 'class="form-control"'); ?>
							<?php endif; ?>
							</div>
							<div class="form-group">
								<input name="nama_bengkel" placeholder="Nama Bengkel" class="form-control" value="<?php echo $nama_bengkel?>">
							</div>
							<div class="form-group">
								<input name="alamat" placeholder="Alamat" class="form-control" value="<?php echo $alamat; ?>">
							</div>
							<div class="form-group">
								<input name="kota" placeholder="Kota" class="form-control" value="<?php echo $kota?>">
							</div>
							<div class="form-group">
								<input name="telp" placeholder="Telepon" class="form-control" value="<?php echo $telp?>">
							</div>
							<div class="form-group">
								<input name="propinsi" placeholder="Propinsi" class="form-control" value="<?php echo $propinsi; ?>">
							</div>
							<div class="form-group">
								<input name="negara" placeholder="Negara" class="form-control" value="<?php echo $negara?>">
							</div>
						</div>
						<div class="form-group">
